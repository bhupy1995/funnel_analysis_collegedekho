...
## Overview
This project analyses a store's database using MySQL. The project is designed to enhance SQL querying skills by solving practical problems.

## Question Sets
1.   Count of records
  
2.   Find out from how many states the data are taken 
     -- A2. 27 states and 4 Union territories (Andaman Nicobar, Chandigarh, Delhi, Puducheri)
...
5.   Find out the states and markets that have had the highest prices of Milk under the milk and dairy category- Retail purchases only
      --A5. Only in 7 states is raw milk sold

6.   Find out the states and markets that have had the highest prices of Milk (pasteurised) under the milk and dairy category- Retail purchases only
...
10.  Finding out the average prices of lentils
     -- A10. Urad has the highest average price of 102.13 INR, and chickpeas have the lowest average price of 46.23 INR
...
13.  Find out the commodities that have the highest prices in the year 2022
     -- Tea comes first, oil comes second, lentils come third

14.  Create a table for zones
     -- Select the city and State from the food prices in the table and insert them into the zones table
...
18.  Find out the average prices of each category of food products, zone-wise
     ...
     -- The North-East zone has the highest average price for Milk and dairy, the South zone has the lowest average
     ...
     -- Union Territory, North East has the highest average price for pulses and nuts(chickpeas and other types of lentils), Central has the lowest average price
     -- The North-East zone has the highest average price for vegetables and fruits, the South has the lowest average
